...
<head>
  ...
  <title>POC Share Wheels - Fleetpark Luxury Products</title>
  ...
  <div class="fleet-page">
    <header class="page-header">
      <div class="site-content-wrap site-content-wrap_small" style="max-width: 51.125rem;">
        <h1 class="heading-1">Een luxe auto huren bij POC Share Wheels</h1>
        <h2 class="intro-text">
          <div class="markdown">
            <p>
              Wil jij voor comfort, luxe en kwaliteit auto hebben? POC Share Wheels introduceert
              nu ook luxe auto's. Voor elk moment en formaat hebben
              wij voor u een passende luxe auto. Bovendien rijd je altijd in
              bekende merken auto's en ben we bieden u standaard hulp bij uw huurauto.
              om je er niet uit? Neem dan gerust contact met ons op
    ...
    <div class="site-content-wrap" style="margin-top: 60px;">
      <div class="main-categories">
        ...
        <a href="fleetpark-luxuryproducts.php" class="main-categories_link active">
          <div class="main-categories_link-image">
                              ...
                              <div class="grid-item">
                                ...
                                <figure class="vehicle-image">
                                  <picture class="image-lazyloaded">
                                    <img width="353" height="199" src="car-products/porsche_panamera_turbo-s.png" class="lazy-img loaded" alt="luxe-auto" loading="lazy">
                                  </picture>
                                </figure>
