  ...
  <div class="fleet-page">
    <header class="page-header">
      <div class="site-content-wrap site-content-wrap_small" style="max-width: 51.125rem;">
        <h1 class="heading-1">Een busje huren bij POC Share Wheels</h1>
        <h2 class="intro-text">
          <div class="markdown">
            <p>
              Huur je bestelauto bij POC Share Wheels. Ga je voor kwaliteit, gemak en wil je huren zonder gedoe?
              Dan ben je hier bij het juiste adres. Bovendien mag je met een rijbewijs B in al onze bestelauto's
              rijden, daar heb je geen speciaal rijbewijs voor nodig! Het beste kwaliteit auto voor een goede prijs.
              Kom je er niet uit? Neem dan gerust contact met ons op of mail naar infopocsharewheels@gmail.com
            </p>
          </div>
        </h2>
      </div>
    ...
    <div class="site-content-wrap" style="margin-top: 60px;">
      <div class="main-categories">
        <a href="fleetpark-carproducts.php" class="main-categories_link">
          <div class="main-categories_link-image">
            <img src="car-products/car-type-car.png" width="43" height="18" alt="Personenauto's" />
          </div>
          <span class="main-categories_link-label">Personenauto's</span>
        </a>

        <a href="fleetpark-vanproducts.php" class="main-categories_link active">
          <div class="main-categories_link-image">
            <img src="car-products/car-type-van.png" width="46" height="19" alt="Bestelauto's" />
          </div>
        ...
        <a href="fleetpark-luxuryproducts.php" class="main-categories_link">
          <div class="main-categories_link-image">
            <img src="car-products/porsche_taycan.png" width="61" height="33" alt="Luxe auto's" />
          </div>
                    ...
                    <fieldset class="vehicle-filters_group">
                      ...
                      <div class="vehicle-filters_checkboxes">
                        <div class="checkbox-base checkbox-filter">
                          <input type="checkbox" id="checkbox-bestelauto" value="Bestelauto" onclick="checkBoxVan()" />
                          <label for="checkbox-bestelauto">
            ...
            <div class="grid-item two-thirds-column">
              <div class="car-finder-results_results">
                <div class="car-finder-results_summary">
                  ...
                  <p class="car-finder-results_subtitle">Alle maten zijn minimale afmetingen</p>
                </div>
                ...
                <section class="vehicle-result-list">
                  <ul class="vehicle-result-list_list">
                    <li class="vehicle-result-list_item">
                      <div class="vehicle vehicle-result" id="VCVN">
                        <div>
                    ...
                    <li class="vehicle-result-list_item">
                      <div class="vehicle vehicle-result" id="MBVN">
                        <div>
                          <div class="card vehicle_card">
                            <div class="grid two-columns align-items-start">
                              <div class="grid-item">
                    ...
                    <li class="vehicle-result-list_item">
                      <div class="vehicle vehicle-result" id="PTVN">
                        <div>
                          <div class="card vehicle_card">
                            <div class="grid two-columns align-items-start">
                              <div class="grid-item">
                    ...
                    <div class="container text-center text-md-start mt-5">
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                          ...
                          <p>
                            <a href="about.php" class="text-white">Personenauto's</a>
                          </p>
                          <p>
                            <a href="about.php" class="text-white">Bestelwagens</a>
                          </p>
                          <p>
                            <a href="about.php" class="text-white">Sportauto's</a>
                          </p>
                        </div>
                        <!-- Grid column -->
