...
<head>
  ...
  <title>POC Share Wheels - Van Results List</title>
                              ...
                              <div class="grid-item">
                                ...
                                <figure class="vehicle-image">
                                  <picture class="image-lazyloaded">
                                    <img width="400" height="230" src="car-products/volkswagen_caddy.png" class="lazy-img loaded" alt="bestelauto" loading="lazy">
                                  </picture>
                                </figure>
                              ...
                              <div class="grid-item vehicle_card-features">
                                <div class="vehicle_features">
                                  <p class="vehicle_feature">
                                    <strong> 150 vrije km </strong>
                                    <span> / € 0,60 per extra km </span>
                                  </p>
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day" id="pricing-product-day"> € 90,00 / dag </span>
                          ...
                          <div class="card vehicle_card">
                            <div class="grid two-columns align-items-start">
                              <div class="grid-item">
                                ...
                                <figure class="vehicle-image">
                                  <picture class="image-lazyloaded">
                                    <img width="353" height="199" src="car-products/mercedes_benz_vito.png" class="lazy-img loaded" alt="bestelauto" loading="lazy">
                                  </picture>
                                </figure>
                                <div class="vehicle_image-actions text-center"></div>
                              </div>
                              <div class="grid-item vehicle_card-features">
                                <div class="vehicle_features">
                                  <p class="vehicle_feature">
                                    <strong> 180 vrije km </strong>
                                    <span> / € 0,80 per extra km </span>
                                  </p>
                                  <p class="vehicle_feature vehicle_extra"> Minimale leeftijd bestuurder 21 jaar </p>
                                  <p class="vehicle_feature vehicle_extra"> Trekhaak en all-season banden op aanvraag </p>
                                  <ul class="icon-list">
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day"> € 115,00 / dag </span>
                          ...
                          <div class="card vehicle_card">
                            <div class="grid two-columns align-items-start">
                              <div class="grid-item">
                                ...
                                <figure class="vehicle-image">
                                  <picture class="image-lazyloaded">
                                    <img width="353" height="199" src="car-products/peugot_expert.png" class="lazy-img loaded" alt="personenauto" loading="lazy">
                                  </picture>
                                </figure>
                                <div class="vehicle_image-actions text-center"></div>
                              </div>
                              <div class="grid-item vehicle_card-features">
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day"> € 150,00 / dag </span>
                                      <span class="vehicle_pricing-total">
