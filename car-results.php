...
<head>
  ...
  <title>POC Share Wheels - Car Results List</title>
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day" id="pricing-product-day"> € 45,00 / dag </span>
                            ...
                            <div class="grid two-columns align-items-start">
                              ...
                              <div class="grid-item vehicle_card-features">
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day"> € 60,00 / dag </span>
                          ...
                          <div class="card vehicle_card">
                            <div class="grid two-columns align-items-start">
                              <div class="grid-item">
                                ...
                                <figure class="vehicle-image">
                                  <picture class="image-lazyloaded">
                                    <img width="353" height="199" src="car-products/opel_mokka_v2.png" class="lazy-img loaded" alt="personenauto" loading="lazy">
                                  </picture>
                                </figure>
                                <div class="vehicle_image-actions text-center"></div>
                              </div>
                              <div class="grid-item vehicle_card-features">
                                ...
                                <div class="vehicle_prices">
                                  ...
                                  <div class="vehicle_pricing">
                                    <div class="vehicle_pricing-row">
                                      <span class="vehicle_pricing-day"> € 80,00 / dag </span>
                                      <span class="vehicle_pricing-total">
                                        <strong>€ 80,00</strong>
                                        totaal
                                      </span>
