...
<html lang="en">
  ...
  <body>
    ...
    <div class="fleet-page">
          ...
          <h2 class="intro-text">
            <div class="markdown">
              <p>
                ...
                of mail naar pocsharewheels@gmail.com
              </p>
            </div>
          </h2>
        </div>
      ...
      <div class="fleet-page_results tmpl bg-grey" style="background: #f6f5f4;">
              ...
              <div class="grid-item one-third-column">
                <section class="vehicle-filters">
                  ...
                  <div class="vehicle-filters_active-filters-heading">
                    <h2>
                      Filters
                      <span class="vehicle-filters_active-filter-count">0</span>
                    </h2>
                    <button
                      class="vehicle-filters_reset-btn"
                      style="display: none;"
                    >
                      Verwijder filters
                    </button>
                      ...
                      <fieldset class="vehicle-filters_group">
                        ...
                        <div class="vehicle-filters_checkboxes">
                          <div class="checkbox-base checkbox-filter">
                            <input
                              type="checkbox"
                              id="checkbox-personenauto"
                              value="Personenauto"
                              onclick="setCheckBoxOn()"
                            />
                                        ...
                                        <div class="grid-item">
                                          ...
                                          <figure class="vehicle-image">
                                             <picture class="image-lazyloaded">
                                               <img width="358" height="179" src="car-products/renault_clio.png" class="lazy-img loaded" alt="personenauto" loading="lazy">
                                             </picture>
                                          </figure>
