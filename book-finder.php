...
if (isset($_POST["order-product-btn"])) {
  ...
  sendEmail(
    $email,
    'POC Share Wheels - Confirmation Order',
    'Beste Gebruiker, <br>
              ...
              <div class="row">
                <div class="booking-form">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        <input class="form-control" type="text" placeholder="Voer uw naam in" id="surname" name="surname" required="" />
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        <input class="form-control" type="text" placeholder="Voer uw achternaam in" id="name" name="name" required="" />
                        <span class="form-label">Achternaam</span>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="form-group">
                        <input class="form-control" type="text" placeholder="Voer uw email in" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required="" />
